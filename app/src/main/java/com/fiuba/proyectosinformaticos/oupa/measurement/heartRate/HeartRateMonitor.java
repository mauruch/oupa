...
import com.fiuba.proyectosinformaticos.oupa.measurement.NewMeasurementStep1;
...
public class HeartRateMonitor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final boolean hasCameraFlash = this.getPackageManager().
        ...
        if (hasCameraFlash) {
            ...
            Toast.makeText(this, "Tu dispositivo no dispone de linterna",
    ...
    private void measureGot(){
        Intent intent = new Intent(HeartRateMonitor.this, HeartRateSendMeasureActivity.class);
        intent.addFlags(FLAG_ACTIVITY_FORWARD_RESULT);
        measurement.value = beatsPerMinuteValue;
